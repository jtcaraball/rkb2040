...
hal::bsp_pins!(
    ...
    /// | Function     | Alias with applied function |
    /// |--------------|-----------------------------|
    /// | `SPI0 RX`    | [crate::Gp17Spi0Rx]         |
    /// | `UART0 TX`   | [crate::Gp17Uart0Tx]        |
    /// | `I2C0 SDA`   | [crate::Gp17I2C0Sda]        |
    /// | `PWM0 A`     | [crate::Gp17Pwm0A]          |
    /// | `PIO0`       | [crate::Gp17Pio0]           |
    /// | `PIO1`       | [crate::Gp17Pio1]           |
    Gpio17 {
        name: gpio17,
